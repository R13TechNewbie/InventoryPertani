            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <a href="/request-bahan-baku"><button type="button" class="btn mb-1 btn-primary mt-2" style="width: 100%;">Input Bahan Baku</button></a>
                    ...
                    <!-- modal -->
                    <form action="/informasi-request-bahan-baku/delete/<?= $b['id_bahan_baku']; ?>" method="post">
