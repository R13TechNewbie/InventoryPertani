                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="/input-barang-jadi-produksi/submit" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-8 ml-auto">
                                        ...
                                        <a href="/informasi-laporan-barang-jadi"><button type="button" class="btn btn-danger">Cancel</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <!-- modal -->
                    <form method="post" action="/input-barang-jadi-produksi/tambah-jenis-barang-jadi">
